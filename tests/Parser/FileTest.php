...
class FileTest extends TestCase
{
    ...
    public function it_validates_a_class_missing_a_method()
    {
        ...
        $fixture = file_get_contents('./../fixtures/Errors/MissingMethod.php');
    ...
    public function it_validates_a_class_missing_the_method_Call()
    {
        ...
        $fixture = file_get_contents('./../fixtures/Errors/MissingMethodCall.php');
    ...
    public function it_validates_a_class_missing_the_closure()
    {
        ...
        $fixture = file_get_contents('./../fixtures/Errors/MissingClosure.php');
